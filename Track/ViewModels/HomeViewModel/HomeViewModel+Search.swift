...
extension HomeViewModel {
    ...
    var filteredGroupedTransit: [GroupedNearbyTransitResponse] {
        ...
        let base = groupedTransit.filter { shouldDisplayInActiveBuckets($0) }
    ...
    var filteredNearbyGroupedBusArrivals: [GroupedNearbyTransitResponse] {
        ...
        ).filter { shouldDisplayInActiveBuckets($0) }
    ...
    private func shouldDisplayInActiveBuckets(_ group: GroupedNearbyTransitResponse) -> Bool {
