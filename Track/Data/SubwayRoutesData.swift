...
struct SubwayRoutesData {
    ...
    static func loadBundle() -> StaticBundle {
        ...
        if let data = UserDefaults(suiteName: appGroupIdentifier)?.data(forKey: "subway_bundle"),
    ...
    static let majorStations: [OfflineStation] = [
        ...
        OfflineStation(
            ...
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
        ...
        OfflineStation(
            ...
            lat: 40.7575, lng: -73.9898,
            routes: ["A","C","E"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "D17", name: "Herald Sq-34 St",
            lat: 40.7496, lng: -73.9879,
            routes: ["B","D","F","M","N","Q","R","W"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "128", name: "Penn Station-34 St",
            lat: 40.7506, lng: -73.9910,
            routes: ["1","2","3","A","C","E"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "R17", name: "Union Sq-14 St",
            lat: 40.7359, lng: -73.9906,
            routes: ["4","5","6","L","N","Q","R","W"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "A32", name: "14 St-8 Av",
            lat: 40.7401, lng: -73.9981,
            routes: ["A","C","E","L"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "R20", name: "Canal St",
            lat: 40.7193, lng: -74.0007,
            routes: [
                "A","C","E","N","Q",
                "R","W","J","Z","6"
            ],
        ...
        OfflineStation(
            id: "R23", name: "City Hall",
            lat: 40.7127, lng: -74.0066,
            routes: ["R","W"],
            borough: "Manhattan", isAccessible: false
        ),
        OfflineStation(
            id: "A36", name: "Chambers St",
            lat: 40.7141, lng: -74.0087,
            routes: ["A","C","1","2","3"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "R27", name: "Whitehall St",
            lat: 40.7031, lng: -74.0129,
            routes: ["R","W","1"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "A40", name: "Fulton St",
            lat: 40.7102, lng: -74.0079,
            routes: ["A","C","J","Z","2","3","4","5"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "635", name: "Wall St",
            lat: 40.7074, lng: -74.0118,
            routes: ["4","5"],
            borough: "Manhattan", isAccessible: false
        ),
        ...
        OfflineStation(
            id: "120", name: "72 St",
            lat: 40.7786, lng: -73.9819,
            routes: ["1","2","3"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "Q04", name: "72 St (2nd Ave)",
            lat: 40.7688, lng: -73.9584,
            routes: ["Q"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "A17", name: "81 St-Museum",
            lat: 40.7818, lng: -73.9728,
            routes: ["A","B","C"],
            borough: "Manhattan", isAccessible: false
        ),
        OfflineStation(
            id: "Q03", name: "86 St (2nd Ave)",
            lat: 40.7776, lng: -73.9517,
            routes: ["Q"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "Q01", name: "96 St (2nd Ave)",
            lat: 40.7846, lng: -73.9474,
            routes: ["Q"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "116", name: "96 St",
            lat: 40.7937, lng: -73.9723,
            routes: ["1","2","3"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "112", name: "116 St-Columbia",
            lat: 40.8077, lng: -73.9642,
            routes: ["1"],
            borough: "Manhattan", isAccessible: false
        ),
        OfflineStation(
            id: "A11", name: "125 St",
            lat: 40.8111, lng: -73.9522,
            routes: ["A","B","C","D"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "621", name: "125 St (Lex)",
            lat: 40.8044, lng: -73.9375,
            routes: ["4","5","6"],
            borough: "Manhattan", isAccessible: true
        ),
        OfflineStation(
            id: "301", name: "Harlem-148 St",
            lat: 40.8241, lng: -73.9363,
            routes: ["3"],
            borough: "Manhattan", isAccessible: false
        ),
        OfflineStation(
            id: "A02", name: "Inwood-207 St",
            lat: 40.8680, lng: -73.9199,
            routes: ["A"],
            borough: "Manhattan", isAccessible: true
        ),
        ...
        // Brooklyn
        OfflineStation(
            id: "R30", name: "Jay St-MetroTech",
            lat: 40.6923, lng: -73.9872,
            routes: ["A","C","F","R"],
            borough: "Brooklyn", isAccessible: true
        ),
        OfflineStation(
            id: "235", name: "Atlantic Av-Barclays",
            lat: 40.6843, lng: -73.9779,
            routes: [
                "2","3","4","5","B",
                "D","N","Q","R"
            ],
        ...
        OfflineStation(
            id: "G29", name: "Bergen St",
            lat: 40.6862, lng: -73.9750,
            routes: ["F","G"],
            borough: "Brooklyn", isAccessible: false
        ),
        OfflineStation(
            id: "D24", name: "Grand Army Plaza",
            lat: 40.6752, lng: -73.9711,
            routes: ["2","3"],
            borough: "Brooklyn", isAccessible: false
        ),
        OfflineStation(
            id: "R36", name: "36 St",
            lat: 40.6551, lng: -74.0034,
            routes: ["D","N","R"],
            borough: "Brooklyn", isAccessible: false
        ),
        OfflineStation(
            id: "F27", name: "Church Av",
            lat: 40.6449, lng: -73.9797,
            routes: ["B","Q"],
            borough: "Brooklyn", isAccessible: true
        ),
        OfflineStation(
            id: "L17", name: "Bedford Av",
            lat: 40.7172, lng: -73.9567,
            routes: ["L"],
            borough: "Brooklyn", isAccessible: true
        ),
        OfflineStation(
            id: "G22", name: "Greenpoint Av",
            lat: 40.7313, lng: -73.9546,
            routes: ["G"],
            borough: "Brooklyn", isAccessible: true
        ),
        OfflineStation(
            id: "A51", name: "Euclid Av",
            lat: 40.6756, lng: -73.8720,
            routes: ["A","C"],
            borough: "Brooklyn", isAccessible: true
        ),
        OfflineStation(
            id: "L29", name: "Canarsie-Rockaway",
            lat: 40.6469, lng: -73.9020,
            routes: ["L"],
            borough: "Brooklyn", isAccessible: true
        ),
        OfflineStation(
            id: "D43", name: "Coney Island-Stillwell Av",
            lat: 40.5755, lng: -73.9814,
            routes: ["D","F","N","Q"],
            borough: "Brooklyn", isAccessible: true
        ),
        OfflineStation(
            id: "A42", name: "Broadway Junction",
            lat: 40.6791, lng: -73.9048,
            routes: ["A","C","J","Z","L"],
            borough: "Brooklyn", isAccessible: false
        ),
        OfflineStation(
        ...
        // Queens
        OfflineStation(
            id: "G14", name: "Court Sq",
            lat: 40.7473, lng: -73.9456,
            routes: ["E","G","M","7"],
            borough: "Queens", isAccessible: true
        ),
        OfflineStation(
            id: "G08", name: "Queens Plaza",
            lat: 40.7490, lng: -73.9373,
            routes: ["E","M","R"],
            borough: "Queens", isAccessible: true
        ),
        OfflineStation(
            id: "F09", name: "Jackson Hts-Roosevelt Av",
            lat: 40.7547, lng: -73.8916,
            routes: ["E","F","M","R","7"],
            borough: "Queens", isAccessible: true
        ),
        OfflineStation(
            id: "701", name: "Flushing-Main St",
            lat: 40.7596, lng: -73.8300,
            routes: ["7"],
            borough: "Queens", isAccessible: true
        ),
        OfflineStation(
            id: "G06", name: "Forest Hills-71 Av",
            lat: 40.7216, lng: -73.8445,
            routes: ["E","F","M","R"],
            borough: "Queens", isAccessible: true
        ),
        OfflineStation(
            id: "A65", name: "Jamaica-179 St",
            lat: 40.7126, lng: -73.7837,
            routes: ["F"],
            borough: "Queens", isAccessible: true
        ),
        OfflineStation(
            id: "H11", name: "Howard Beach-JFK Airport",
            lat: 40.6602, lng: -73.8303,
            routes: ["A"],
            borough: "Queens", isAccessible: true
        ),
        OfflineStation(
            id: "H01", name: "Far Rockaway-Mott Av",
            lat: 40.6003, lng: -73.7550,
            routes: ["A"],
            borough: "Queens", isAccessible: true
        ),
        OfflineStation(
            id: "718", name: "Woodside-61 St",
            lat: 40.7456, lng: -73.9029,
            routes: ["7"],
            borough: "Queens", isAccessible: true
        ),
        ...
        OfflineStation(
            ...
            lat: 40.8522, lng: -73.8283,
            routes: ["6"],
            borough: "Bronx", isAccessible: true
        ),
        OfflineStation(
            id: "401", name: "Woodlawn",
            lat: 40.8863, lng: -73.8788,
            routes: ["4"],
            borough: "Bronx", isAccessible: false
        ),
        OfflineStation(
            id: "213", name: "E 180 St",
            lat: 40.8418, lng: -73.8737,
            routes: ["2","5"],
            borough: "Bronx", isAccessible: true
        ),
        OfflineStation(
            id: "D01", name: "Norwood-205 St",
            lat: 40.8750, lng: -73.8904,
            routes: ["D"],
            borough: "Bronx", isAccessible: false
        ),
        OfflineStation(
            id: "501", name: "Eastchester-Dyre Av",
            lat: 40.8887, lng: -73.8308,
            routes: ["5"],
            borough: "Bronx", isAccessible: false
        ),
        OfflineStation(
            id: "201", name: "Wakefield-241 St",
            lat: 40.9033, lng: -73.8506,
            routes: ["2"],
            borough: "Bronx", isAccessible: false
        ),
        OfflineStation(
            id: "D11", name: "161 St-Yankee Stadium",
            lat: 40.8279, lng: -73.9257,
            routes: ["4","B","D"],
            borough: "Bronx", isAccessible: true
        ),
    ]
    ...
    /// Get ALL branch coordinates for a route line
    /// (for routes like A train with Lefferts/Far Rockaway branches)
...
/// Version 2.x: routes is a dict mapping route_id
/// to list of branches (each branch is a list of coordinates)
