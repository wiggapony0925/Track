...
_GAZETTEER: dict[str, tuple[float, float]] = {
    ...
    "noho": (40.7281, -73.9929),
    "nolita": (40.7228, -73.9956),
    "fidi": (40.7074, -74.0113),
    ...
    "manhattan bridge": (40.7074, -73.9904),
    "williamsburg bridge": (40.7134, -73.9722),
    ...
    "tims square": (40.7580, -73.9855),
    "tims sq": (40.7580, -73.9855),
    "tims": (40.7580, -73.9855),
