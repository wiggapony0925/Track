...
def run_ingestion():
    ...
    if subway_path.exists():
        ...
        ingest_file(conn, subway_path / "stops.txt", "stops", {
            "stop_id": "stop_id", "stop_name": "stop_name", "stop_lat": "stop_lat", "stop_lon": "stop_lon"
        })
        ingest_file(conn, subway_path / "routes.txt", "routes", {
            "route_id": "route_id", "route_short_name": "route_short_name", 
            "route_long_name": "route_long_name", "route_color": "route_color", "route_type": "route_type"
        })
        ingest_file(conn, subway_path / "trips.txt", "trips", {
            "trip_id": "trip_id", "route_id": "route_id", "service_id": "service_id", 
            "trip_headsign": "trip_headsign", "direction_id": "direction_id"
        })
        ingest_file(conn, subway_path / "stop_times.txt", "stop_times", {
            "trip_id": "trip_id", "arrival_time": "arrival_time", 
            "departure_time": "departure_time", "stop_id": "stop_id", "stop_sequence": "stop_sequence"
        })
        ingest_file(conn, subway_path / "calendar_dates.txt", "calendar_dates", {
            "service_id": "service_id", "date": "date", "exception_type": "exception_type"
        })
    ...
    if lirr_path.exists():
        print("\n🚆 Processing LIRR...")
        ingest_file(conn, lirr_path / "stops.txt", "stops", {
            "stop_id": "stop_id", "stop_name": "stop_name", "stop_lat": "stop_lat", "stop_lon": "stop_lon"
        })
        ingest_file(conn, lirr_path / "routes.txt", "routes", {
            "route_id": "route_id", "route_short_name": "route_short_name", 
            "route_long_name": "route_long_name", "route_color": "route_color", "route_type": "route_type"
        })
        ingest_file(conn, lirr_path / "trips.txt", "trips", {
            "trip_id": "trip_id", "route_id": "route_id", "service_id": "service_id", 
            "trip_headsign": "trip_headsign", "direction_id": "direction_id"
        })
        ingest_file(conn, lirr_path / "stop_times.txt", "stop_times", {
            "trip_id": "trip_id", "arrival_time": "arrival_time", 
            "departure_time": "departure_time", "stop_id": "stop_id", "stop_sequence": "stop_sequence"
        })
        ingest_file(conn, lirr_path / "calendar_dates.txt", "calendar_dates", {
            "service_id": "service_id", "date": "date", "exception_type": "exception_type"
        })
    ...
    if mnr_path.exists():
        ...
        ingest_file(conn, mnr_path / "stops.txt", "stops", {
            "stop_id": "stop_id", "stop_name": "stop_name", "stop_lat": "stop_lat", "stop_lon": "stop_lon"
        })
        # Note: LIRR/MNR often share routes/trips logic
        ingest_file(conn, mnr_path / "routes.txt", "routes", {
            "route_id": "route_id", "route_short_name": "route_short_name", 
            "route_long_name": "route_long_name", "route_color": "route_color", "route_type": "route_type"
        })
        ingest_file(conn, mnr_path / "trips.txt", "trips", {
            "trip_id": "trip_id", "route_id": "route_id", "service_id": "service_id", 
            "trip_headsign": "trip_headsign", "direction_id": "direction_id"
        })
        ingest_file(conn, mnr_path / "stop_times.txt", "stop_times", {
            "trip_id": "trip_id", "arrival_time": "arrival_time", 
            "departure_time": "departure_time", "stop_id": "stop_id", "stop_sequence": "stop_sequence"
        })
        ingest_file(conn, mnr_path / "calendar_dates.txt", "calendar_dates", {
            "service_id": "service_id", "date": "date", "exception_type": "exception_type"
        })
    ...
    if bus_base_path.exists():
        boroughs = ["Bronx", "Brooklyn", "Manhattan", "Queens", "Staten Island", "MTA Bus Company"]
        for borough in boroughs:
            ...
            ingest_file(conn, path / "stops.txt", "stops", {
                "stop_id": "stop_id", "stop_name": "stop_name", "stop_lat": "stop_lat", "stop_lon": "stop_lon"
            })
            ingest_file(conn, path / "routes.txt", "routes", {
                "route_id": "route_id", "route_short_name": "route_short_name", 
                "route_long_name": "route_long_name", "route_color": "route_color", "route_type": "route_type"
            })
            ingest_file(conn, path / "trips.txt", "trips", {
                "trip_id": "trip_id", "route_id": "route_id", "service_id": "service_id", 
                "trip_headsign": "trip_headsign", "direction_id": "direction_id"
            })
            ingest_file(conn, path / "stop_times.txt", "stop_times", {
                "trip_id": "trip_id", "arrival_time": "arrival_time", 
                "departure_time": "departure_time", "stop_id": "stop_id", "stop_sequence": "stop_sequence"
            })
            ingest_file(conn, path / "calendar_dates.txt", "calendar_dates", {
                "service_id": "service_id", "date": "date", "exception_type": "exception_type"
            })
